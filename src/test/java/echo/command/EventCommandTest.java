...
public class EventCommandTest {
    ...
    public void execute_missingFromArgument_errorMessageShown() {
        String expected = Ui.getInvalidArgumentsWarning("event");
        ...
        String actual = new EventCommand(splitUserInput, userInput, null, null).execute();
    ...
    public void execute_normalInput_success() {
        ...
        try {
            ...
            String actual = new EventCommand(splitUserInput, userInput, taskManager, storage).execute();
            assertEquals(expected, actual);
        } catch (IOException e) {
            fail();
        }
